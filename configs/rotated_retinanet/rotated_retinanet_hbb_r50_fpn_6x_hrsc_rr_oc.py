...
#     module=model,  # This refers to the RetinaNet dict defined above
#     tta_cfg=dict(
#         nms=dict(type='nms_rotated', iou_threshold=0.5),
#         max_per_img=2000
#     )
...
tta_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            # Third dimension: Packing
            [dict(type='mmdet.PackDetInputs')]
        ])
]

test_cfg = dict(type='TTALoop')

val_evaluator = dict(
    type='DOTAMetric',
    metric='mAP',
    # Ensure this matches the box type used in your pipeline
    predict_box_type='rbox')
test_evaluator = val_evaluator

# 3. Apply to Config
_base_.test_dataloader['dataset']['pipeline'] = tta_pipeline
